...
const OrderedListItem = styled.View`
  flex: 1;
  flex-direction: row;
...
const BoldText = RegularText.extend`
  font-weight: bold;
`;
...
const ListItem = (props) => (
  <OrderedListItem>
    <ListItemNumber>{props.bullet}</ListItemNumber><RegularText>{props.children}</RegularText>
  </OrderedListItem>
);
          ...
          <ContainerInner>
              <List>
                ...
                <ListItemWrap>
                  ...
                  <ListItem bullet='3.'><BoldText>Użytkownik</BoldText> - osoba korzystająca z Serwisu - osoba fizyczna, osoba prawna lub jednostka organizacyjna.</ListItem>
                  <ListItem bullet='4.'><BoldText>Serwis</BoldText> - aplikacja internetowa służąca do rozliczania delegacji krajowych i zagranicznych, zgodnie z obowiązującymi przepisami prawa polskiego.</ListItem>
                  <ListItem bullet='5.'><BoldText>Usługa</BoldText> - usługa świadczona drogą elektroniczną przez Administratora za pomocą Serwisu w oparciu o Regulamin.</ListItem>
                  <ListItem bullet='6.'><BoldText>Umowa</BoldText> - umowa w rozumieniu ustawy Kodeks cywilny, zawierana pomiędzy Usługodawcą a Usługobiorcą z wykorzystaniem środków porozumiewania się na odległość, której przedmiotem jest Usługa</ListItem>
                </ListItemWrap>
              </List>
              ...
              <List>
                <SubtitleWrap><Subtitle>Określenie warunków korzystania z usługi</Subtitle></SubtitleWrap>
                <ListItemWrap>
              ...
              <List>
                <SubtitleWrap><Subtitle>Zakres odpowiedzialności Administratora</Subtitle></SubtitleWrap>
                <ListItemWrap>
              ...
              <List>
                <SubtitleWrap><Subtitle>Zasady zawierania, zmiany oraz rozwiązywania umowy</Subtitle></SubtitleWrap>
                <ListItemWrap>
              ...
              <List>
                <SubtitleWrap><Subtitle>Polityka prywatności</Subtitle></SubtitleWrap>
                <ListItemWrap>
              ...
              <List>
                <SubtitleWrap><Subtitle>Postanowienia końcowe</Subtitle></SubtitleWrap>
                <ListItemWrap>
