...
export const setAlimentationProvided = (value, text) => ({type: 'SET_ALIMENTATION_PROVIDED', payload: value, text});
export const setAccomodationProvided = (value, text) => ({type: 'SET_ACCOMODATION_PROVIDED', payload: value, text});
